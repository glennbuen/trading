...
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | **INTC** | Trend reversal/continuation | Swing | Short-term (T1 exit) | Strongest catalyst reviewed so far — multiple concrete confirmed events, not sentiment: **US government holds a 10% stake**; Nvidia investing $5B to co-develop custom x86 CPUs + $8.9B government investment; **Apple reportedly designing/building chips with Intel in the US** (stock +8-11% on this news); 18A-P process entering risk production on time; $20B+ raise saw $100B in institutional demand. Next earnings Oct 22 — ~6 weeks out, outside T1 horizon. | $100–106 (this week's low to current — a live test of weekly MA20 at 107.36) | ~$91–94 (1–1.5x daily ATR 5.38 below MA50 99.62) | ~$115–120 (~9-15% off entry) | $101.53, real intraday 10:07 AM EDT (+4.52%) | ✅ Filled, see Current Holdings above — **back INSIDE the entry zone (₱100-106)**, real recovery today; stop (~$91-94) gap back out to ~8.0% | Weekly close above 107.36 (MA20), or daily close above EMA10 |
...
$214.20) → HOOD bought (-$10.60, 0.1 sh × $105.96) → **cash
≈$29.57**. All figures
...
| **INTC** | $101.6173 (0.15 fractional sh, $15.24) | $101.53, real intraday 2026-09-16 10:07 AM EDT (+4.52%) — **corrects the earlier stale "$97.14 confirmed close" label** | -0.09% | ~$91–94 (no automated stop — same fractional-share gap) | Full exit at T1 ~$115–120 per this account's T1-exit rule | ✅ Real recovery today, back essentially at cost basis. Stop gap ~8.0%, clear. |
...
| **PLTR** | $171.13 (0.07 fractional sh, $11.98) | $170.06, real intraday 2026-09-16 10:07 AM EDT (-1.45%) | -0.63% | ~$161–165 (1–1.5x daily ATR7.44 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$205–208 per this account's T1-exit rule | 🟢 Filled below the stated entry zone ($172.49-175.52) — a better entry than planned. Mild pullback today, stop still clear (~3.1% gap). Fresh, convergent catalyst intact (3 analyst target raises within days). |
| **NBIS** | $214.20 (0.05 fractional sh, $10.71) | $213.68, real intraday 2026-09-16 10:06 AM EDT (+3.04%) | -0.24% | ~$196–205 (1–1.5x daily ATR18.53 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$250–255 per this account's T1-exit rule | ⚠️ **Worth being precise about this fill**: the original stated entry zone was $223.70–228.90 — this filled well BELOW that, during the recovery bounce off a level that had come within ~1.2% of the stop just hours earlier. A discretionary buy-the-bounce entry, not the standard "fills inside the stated zone" pattern used elsewhere. Stop gap ~4.2%, clear. Real catalyst on file (Palantir enterprise deal, Sept 8). |
| **HOOD** | $105.96 (0.1 fractional sh, $10.60) | $105.53, real intraday 2026-09-16 10:22 AM EDT (-4.45%) | -0.41% | ~$99–102 (1–1.5x daily ATR6.44 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$135–138 per this account's T1-exit rule | 🟡 Filled below the stated entry zone ($108.71-112.49), during today's steep sector-correlated drop (COIN regulatory news dragging crypto-adjacent names). Stop gap only ~3.3% at the near bound — the tightest gap of any open position right now. Real two-sided catalyst on file (Aug platform assets +26%, two analyst target raises this month vs. genuine 2026 fundamental softness). |
