...
|---|---|---|---|---|---|---|
| **NVDA** | $218.41 (0.07 fractional sh, $15.29) | **$212.04, after-hours 2026-09-14 (+0.51%)** — regular close was $210.96 (-3.36%), inside the stop zone | -2.92% | ~$210–213 (no automated stop — Webull SG doesn't support one on fractional shares, see Broker & capital) | Full exit at T1 ~$236–240 per this account's T1-exit rule | 🔴 **Confirmed: user did NOT execute the stated stop-check plan** ("i need more discipline," their words) — position still held past a confirmed close inside the stop zone. Logged as a discipline lesson in `TRADE_JOURNAL.md`, not a P&L event. **Decision to sell now explicitly deferred by the user ("i'll sell later") — still an open, unresolved stop condition, not resolved by the deferral.** |
| **INTC** | $101.6173 (0.15 fractional sh, $15.24) | **$97.19, CONFIRMED regular-session close 2026-09-14 (-5.59%)** — after-hours $97.55 (+0.37%) | -4.36% | ~$91–94 (no automated stop — same fractional-share gap) | Full exit at T1 ~$115–120 per this account's T1-exit rule | ⚠️ Confirmed close is ~3.4% above the stop zone's top end — narrower than before, still clear, same broad selloff not INTC-specific. |
