...
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | **INTC** | Trend reversal/continuation | Swing | Short-term (T1 exit) | Strongest catalyst reviewed so far — multiple concrete confirmed events, not sentiment: **US government holds a 10% stake**; Nvidia investing $5B to co-develop custom x86 CPUs + $8.9B government investment; **Apple reportedly designing/building chips with Intel in the US** (stock +8-11% on this news); 18A-P process entering risk production on time; $20B+ raise saw $100B in institutional demand. Next earnings Oct 22 — ~6 weeks out, outside T1 horizon. | $100–106 (this week's low to current — a live test of weekly MA20 at 107.36) | ~$91–94 (1–1.5x daily ATR 5.38 below MA50 99.62) | ~$115–120 (~9-15% off entry) | $108.60, confirmed close 2026-09-18 4:00 PM EDT (-0.18%) | ✅ Filled, see Current Holdings above — held yesterday's gain, now +6.87% unrealized; stop (~$91-94) gap ~13.4-16.2% | Weekly close above 107.36 (MA20), or daily close above EMA10 |
...
| **INTC** | $101.6173 (0.15 fractional sh, $15.24) | $108.60, confirmed close 2026-09-18 4:00 PM EDT (-0.18%) | +6.87% | ~$91–94 (no automated stop — same fractional-share gap) | Full exit at T1 ~$115–120 per this account's T1-exit rule | 🟢 Holding yesterday's gain, essentially flat today. Stop gap ~13.4-16.2%. ~6-9% below T1 zone. |
...
| **PLTR** | $171.13 (0.07 fractional sh, $11.98) | $177.64, confirmed close 2026-09-18 4:00 PM EDT (+0.79%) | +3.80% | ~$161–165 (1–1.5x daily ATR7.44 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$205–208 per this account's T1-exit rule | 🟢 Third green close running. Stop gap ~7.1-9.4%, clear. |
| **NBIS** | $214.20 (0.05 fractional sh, $10.71) | $223.54, confirmed close 2026-09-18 4:00 PM EDT (+2.55%) | +4.36% | ~$196–205 (1–1.5x daily ATR18.53 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$250–255 per this account's T1-exit rule | 🟢 Second green close running. Stop gap ~8.3-12.3%, clear. |
| **HOOD** | $105.96 (0.1 fractional sh, $10.60) | $119.82, confirmed close 2026-09-18 4:00 PM EDT (+9.12%) | +13.08% | ~$99–102 (1–1.5x daily ATR6.44 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$135–138 per this account's T1-exit rule | 🟢 Best performer on the account — a second big rally day. Stop gap widened to ~14.9-17.4%. Now only ~12-15% below T1 ($135-138). |
