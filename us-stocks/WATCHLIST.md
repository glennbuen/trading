...
**⚠️ Broad pre-market selloff, 2026-09-14 (~5 AM EDT) — every name below is down, this is macro/sector-wide, not stock-specific.** Trigger: leading AI labs called for an industry-wide AI-development slowdown, hitting chip/AI-infra names hardest; also rising bond yields and an upcoming Fed meeting this week. All prices below marked "PRE-MARKET" are unconfirmed, thinly-traded quotes from ~5 AM EDT — **verify against the actual regular-session price before acting on any of this**, pre-market can gap back significantly by the open.
...
|---|---|---|---|---|---|---|
| **NVDA** | $218.41 (0.07 fractional sh, $15.29) | **PRE-MARKET $212.13 (-2.82%), Sept 14 5:06 AM EDT — not a confirmed regular-session print, verify in Webull before acting** (last confirmed close $218.36) | -2.88% (vs. pre-market) | ~$210–213 (no automated stop — Webull SG doesn't support one on fractional shares, see Broker & capital) | Full exit at T1 ~$236–240 per this account's T1-exit rule | 🔴 **Pre-market price is now INSIDE the stated stop zone ($210–213)** — driven by a broad AI-sector selloff (see note below), not NVDA-specific news. If the regular session opens near this level, the stop is live. **User's plan, stated 2026-09-14: give the first 30 minutes after the regular open (9:30-10:00 AM ET) to see if price recovers off the pre-market level; sell if it hasn't by then.** This is a manual decision either way — no automated stop exists on this fractional position. |
| **INTC** | $101.6173 (0.15 fractional sh, $15.24) | **PRE-MARKET $96.80 (-5.96%), Sept 14 5:06 AM EDT — not a confirmed regular-session print, verify in Webull before acting** (last confirmed close $102.94) | -4.74% (vs. pre-market) | ~$91–94 (no automated stop — same fractional-share gap) | Full exit at T1 ~$115–120 per this account's T1-exit rule | ⚠️ Still ~3% above the stop zone's top end even at the pre-market price, but the gap has narrowed sharply — same broad selloff, not INTC-specific. |
