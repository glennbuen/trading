...
$48.24 cash (user-confirmed 2026-09-11). **Updated 2026-09-16**: NVDA
stopped out, gross proceeds ≈$14.85 (0.07 sh × $212.08) → cash
≈$63.09. AMZN bought, $12.64 (0.05 sh × $252.72) → **cash ≈$50.45**.
All figures gross/estimated, not net of fees — ask for exact confirmed
...
| **INTC** | $101.6173 (0.15 fractional sh, $15.24) | **PRE-MARKET $98.42, Sept 15 (+1.3% vs. Monday's confirmed close $97.19) — unconfirmed, verify before acting** | -3.15% | ~$91–94 (no automated stop — same fractional-share gap) | Full exit at T1 ~$115–120 per this account's T1-exit rule | ⚠️ Bouncing back from Monday's low, ~4.7% above the stop zone's top end — clear, no concern here. |
| **AMZN** | $252.72 (0.05 fractional sh, $12.64) | $248.42 (-1.93% today) | -1.70% | ~$246–249 (1–1.5x daily ATR6.27 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$283–287 per this account's T1-exit rule | 🔴 **Filled below the stated entry zone ($255-259) — a better entry than planned — but the stop is already being tested just days later.** Current price ($248.42) is INSIDE the stop range ($246-249). No automated stop exists on this fractional position — this needs a manual decision, same situation NVDA was just in. |
