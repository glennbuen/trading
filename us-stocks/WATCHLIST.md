...
| 5 | **NVDA** | Trend pullback/continuation (cleanest yet) | Swing | Short-term (T1 exit) | No near-term earnings risk (next report Nov 17/25 — 2+ months out). DOJ probing Nvidia's $20B Groq licensing deal for antitrust concerns — real but a known, ongoing story since December, background risk not a fresh acute catalyst. | $220.80–223.67 (MA20/EMA10/current cluster — may already be live) | ~$210–213 (1–1.5x daily ATR 7.15 below MA20, under MA50 211.80) | ~$236–240 (52w-high retest, ~6-8% off entry) | PRE-MARKET $212.27, Sept 15 (+0.6% vs. Monday's close $210.96) | 🔴 Filled, see Current Holdings above — **still sitting inside the stop zone ($210-213), second session running** | Next daily candle no fresh low, or close back above EMA10 (223.16, now stale — worth a fresh chart) |
...
|---|---|---|---|---|---|---|
| **NVDA** | $218.41 (0.07 fractional sh, $15.29) | **PRE-MARKET $212.27, Sept 15 (+0.6% vs. Monday's confirmed close $210.96) — unconfirmed, verify before acting** | -2.81% | ~$210–213 (no automated stop — Webull SG doesn't support one on fractional shares, see Broker & capital) | Full exit at T1 ~$236–240 per this account's T1-exit rule | 🔴 **Still sitting inside the stop zone on the latest read — this is now the second session the position has been at or past the stop, with the sell still explicitly deferred ("i'll sell later").** Not a new development, a continuation of an unresolved one. |
