...
| 10 | **HOOD** | Trend pullback/continuation (no weekly overhang, real distance from highs) | Swing | Short-term (T1 exit) | Real, two-sided story: fell 32% YTD earlier in 2026 on genuine fundamentals (Q1 miss, crypto revenue -47%, July equity volumes -15% MoM / crypto volumes -33% MoM) — but August platform assets hit $384B (+26%), and two analysts raised targets just this month (Deutsche Bank to $138 Sept 11, Citizens to $165 Sept 10). Today's -3.39% likely sector-correlated with COIN's regulatory-driven drop (Senate rejected the Digital Asset Market CLARITY Act), not HOOD-specific. Next earnings Nov 4 — ~7 weeks out, outside T1 horizon. | $108.71–112.49 (daily MA20/EMA10/VWAP cluster — live now) | ~$99–102 (1–1.5x daily ATR 6.44 below the zone, confluence with daily MA50 103.32) | ~$135–138 (R-multiple based, ~2.5:1 — no clean structural level exists between here and the distant 52w high $153.86, flagged not hidden, same situation as NIKL/Philweb) | $107.46, real intraday 10:06 AM EDT (-2.71%) | 🟡 Pulled back below the $108.71-112.49 zone — a deeper test than before | Next daily candle no fresh low vs. today (105.86), or close remains above EMA10 (112.49) |
