...
(-$11.98, 0.07 sh × $171.13) → **cash ≈$50.88**. All figures
...
| **PLTR** | $171.13 (0.07 fractional sh, $11.98) | $172.56 (-0.43% today) | +0.84% | ~$161–165 (1–1.5x daily ATR7.44 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$205–208 per this account's T1-exit rule | 🟢 Filled below the stated entry zone ($172.49-175.52) — a better entry than planned, same pattern as every other real fill this account has made. Fresh, convergent catalyst (3 analyst target raises within days). Stop clear, real room to T1. |
