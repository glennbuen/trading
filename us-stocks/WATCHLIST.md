...
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | **INTC** | Trend reversal/continuation | Swing | Short-term (T1 exit) | Strongest catalyst reviewed so far — multiple concrete confirmed events, not sentiment: **US government holds a 10% stake**; Nvidia investing $5B to co-develop custom x86 CPUs + $8.9B government investment; **Apple reportedly designing/building chips with Intel in the US** (stock +8-11% on this news); 18A-P process entering risk production on time; $20B+ raise saw $100B in institutional demand. Next earnings Oct 22 — ~6 weeks out, outside T1 horizon. | $100–106 (this week's low to current — a live test of weekly MA20 at 107.36) | ~$91–94 (1–1.5x daily ATR 5.38 below MA50 99.62) | ~$115–120 (~9-15% off entry) | $108.80, confirmed close 2026-09-17 4:00 PM EDT (+7.75%) | ✅ Filled, see Current Holdings above — real rally day, now +7.07% unrealized, comfortably above the entry zone; stop (~$91-94) gap widened to ~13.6-16.4% | Weekly close above 107.36 (MA20), or daily close above EMA10 |
...
| **INTC** | $101.6173 (0.15 fractional sh, $15.24) | $108.80, confirmed close 2026-09-17 4:00 PM EDT (+7.75%) | +7.07% | ~$91–94 (no automated stop — same fractional-share gap) | Full exit at T1 ~$115–120 per this account's T1-exit rule | 🟢 Real rally day, first clean green position since the fill. Stop gap widened to ~13.6-16.4%. Only ~7-10% below T1 zone now. |
...
| **PLTR** | $171.13 (0.07 fractional sh, $11.98) | $176.24, confirmed close 2026-09-17 4:00 PM EDT (+1.09%) | +2.99% | ~$161–165 (1–1.5x daily ATR7.44 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$205–208 per this account's T1-exit rule | 🟢 Second green close running. Stop gap widened to ~6.4-8.6%, clear. Fresh, convergent catalyst intact (3 analyst target raises within days). |
| **NBIS** | $214.20 (0.05 fractional sh, $10.71) | $217.99, confirmed close 2026-09-17 4:00 PM EDT (+4.12%) | +1.77% | ~$196–205 (1–1.5x daily ATR18.53 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$250–255 per this account's T1-exit rule | 🟢 Confirmed real, the after-hours pop held through a full session. Now green, stop gap widened back to ~6.0-10.1%. Real catalyst: company raised prices on compute offerings. |
| **HOOD** | $105.96 (0.1 fractional sh, $10.60) | $109.81, confirmed close 2026-09-17 4:00 PM EDT (+5.16%) | +3.63% | ~$99–102 (1–1.5x daily ATR6.44 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$135–138 per this account's T1-exit rule | 🟢 Real recovery, tightest position on the account just bounced clean. Stop gap widened back to ~7.1-9.8%. |
