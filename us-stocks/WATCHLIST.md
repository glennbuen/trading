...
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | **INTC** | Trend reversal/continuation | Swing | Short-term (T1 exit) | Strongest catalyst reviewed so far — multiple concrete confirmed events, not sentiment: **US government holds a 10% stake**; Nvidia investing $5B to co-develop custom x86 CPUs + $8.9B government investment; **Apple reportedly designing/building chips with Intel in the US** (stock +8-11% on this news); 18A-P process entering risk production on time; $20B+ raise saw $100B in institutional demand. Next earnings Oct 22 — ~6 weeks out, outside T1 horizon. | $100–106 (this week's low to current — a live test of weekly MA20 at 107.36) | ~$91–94 (1–1.5x daily ATR 5.38 below MA50 99.62) | ~$115–120 (~9-15% off entry) | $97.14, confirmed close 2026-09-16 (-0.05%) | ✅ Filled, see Current Holdings above — still below the entry zone; stop (~$91-94) gap narrowed to ~3.3% | Weekly close above 107.36 (MA20), or daily close above EMA10 |
...
| **INTC** | $101.6173 (0.15 fractional sh, $15.24) | $97.14, confirmed close 2026-09-16 (-0.05%) | -4.40% | ~$91–94 (no automated stop — same fractional-share gap) | Full exit at T1 ~$115–120 per this account's T1-exit rule | ⚠️ Stop gap narrowed to ~3.3% — still clear, but closer than before. |
