...
|---|---|---|---|---|---|---|
| **NVDA** | $218.41 (0.07 fractional sh, $15.29) | **$210.96, CONFIRMED regular-session close 2026-09-14 (-3.36%)** — after-hours ticked up slightly to $212.10 (+0.54%) | -3.41% | ~$210–213 (no automated stop — Webull SG doesn't support one on fractional shares, see Broker & capital) | Full exit at T1 ~$236–240 per this account's T1-exit rule | 🔴 **CONFIRMED CLOSE WAS INSIDE THE STOP ZONE ($210–213)** — this is no longer a pre-market flag, it's the actual Monday close. **Status of your stated plan (check 30 min post-open, sell if not recovered) unknown from here — did you execute it? If not yet, this needs a decision now, not at the next scheduled check.** |
