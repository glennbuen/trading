...
| 4 | **TSM** | Trend pullback/continuation | Swing | Short-term (T1 exit) | Extremely strong, consistent (not one-quarter) growth: Aug revenue +53.3% YoY, Q2 2026 revenue +36%/net income +77.4% YoY, Q3 guidance $44.6-45.8B rev at 65-67% gross margin. AI chip demand outstripping supply. Next earnings ~mid-October, moderate distance out. | $420–425 (daily MA50/MA20/EMA10 cluster, current price only ~2.5-3.5% above — close to live) | ~$403–409 (1–1.5x daily ATR 11.49 below zone) | ~$460–475 (~9-13% off entry, approaching 52w high 479.00) | $451.15, confirmed close 2026-09-24 4:00 PM EDT (+1.03%) | 🟡 Back to green, still well above the original $420-425 zone that already passed. Reviewed via full daily+weekly chart 2026-09-23 — real uptrend confirmed but was already extended, not a fresh entry | Next daily candle no fresh low, or close back above EMA10 |
...
| **PLTR** | $171.13 (0.07 fractional sh, $11.98) | $192.59, confirmed close 2026-09-24 4:00 PM EDT (+0.42%) | +12.54% | ~$161–165 (1–1.5x daily ATR7.44 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$205–208 per this account's T1-exit rule | 🟢 Seventh green close running. Stop gap ~14.4-16.4%, clear. ~6.5-7.5% below T1. |
| **NBIS** | $214.20 (0.05 fractional sh, $10.71) | $243.48, confirmed close 2026-09-24 4:00 PM EDT (+7.44%) | +13.67% | ~$196–205 (1–1.5x daily ATR18.53 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$250–255 per this account's T1-exit rule | 🟢 Strong bounce back, best single-day gain of the position's history. Stop gap ~15.8-19.5%, clear. Only ~2.6-4.7% below T1 now. |
| **HOOD** | $105.96 (0.1 fractional sh, $10.60) | $120.82, confirmed close 2026-09-24 4:00 PM EDT (-1.53%) | +14.02% | ~$99–102 (1–1.5x daily ATR6.44 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$135–138 per this account's T1-exit rule | 🟡 Second straight red close — still the best performer overall, stop gap ~18.8-23.8%, ~11.3-13.6% below T1. |
| **MSFT** | $493.81 (0.03 fractional sh, $14.81, real fill, 2026-09-21) | $497.93, confirmed close 2026-09-24 4:00 PM EDT (-0.53%) | +0.83% | ~$477–482 (1–1.5x daily ATR10.66 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$540–554 per this account's T1-exit rule | 🟡 Second red close, still well above the $492-497 entry zone and the stop. Stop gap ~3.9-4.9%. |
