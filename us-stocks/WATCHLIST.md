...
| 4 | **TSM** | Trend pullback/continuation | Swing | Short-term (T1 exit) | Extremely strong, consistent (not one-quarter) growth: Aug revenue +53.3% YoY, Q2 2026 revenue +36%/net income +77.4% YoY, Q3 guidance $44.6-45.8B rev at 65-67% gross margin. AI chip demand outstripping supply. Next earnings ~mid-October, moderate distance out. | $420–425 (daily MA50/MA20/EMA10 cluster, current price only ~2.5-3.5% above — close to live) | ~$403–409 (1–1.5x daily ATR 11.49 below zone) | ~$460–475 (~9-13% off entry, approaching 52w high 479.00) | $450.61, confirmed close 2026-09-25 4:00 PM EDT (-0.12%) | 🟡 Roughly flat, still well above the original $420-425 zone that already passed. Reviewed via full daily+weekly chart 2026-09-23 — real uptrend confirmed but was already extended, not a fresh entry | Next daily candle no fresh low, or close back above EMA10 |
...
| **PLTR** | $171.13 (0.07 fractional sh, $11.98) | $189.67, confirmed close 2026-09-25 4:00 PM EDT (-1.52%) | +10.83% | ~$161–165 (1–1.5x daily ATR7.44 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$205–208 per this account's T1-exit rule | 🟡 Streak broken after seven green closes — still well above the stop, not a concern. |
| **NBIS** | $214.20 (0.05 fractional sh, $10.71) | $237.33, confirmed close 2026-09-25 4:00 PM EDT (-2.53%) | +10.80% | ~$196–205 (1–1.5x daily ATR18.53 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$250–255 per this account's T1-exit rule | 🟡 Gave back part of the prior day's big gain — still ~5.6-7.6% below T1, the full-exit decision hasn't been triggered |
| **HOOD** | $105.96 (0.1 fractional sh, $10.60) | $119.40, confirmed close 2026-09-25 4:00 PM EDT (-1.18%) | +12.68% | ~$99–102 (1–1.5x daily ATR6.44 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$135–138 per this account's T1-exit rule | 🟡 Third straight red close — still the best performer overall, stop gap ~17.2-22.3% |
| **MSFT** | $493.81 (0.03 fractional sh, $14.81, real fill, 2026-09-21) | $516.17, confirmed close 2026-09-25 4:00 PM EDT (+3.66%) | +4.53% | ~$477–482 (1–1.5x daily ATR10.66 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$540–554 per this account's T1-exit rule | 🟢 Strong day, best close since the fill, back well above the $492-497 zone. Stop gap ~7.1-8.2%. |
