...
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | **INTC** | Trend reversal/continuation | Swing | Short-term (T1 exit) | Strongest catalyst reviewed so far — multiple concrete confirmed events, not sentiment: **US government holds a 10% stake**; Nvidia investing $5B to co-develop custom x86 CPUs + $8.9B government investment; **Apple reportedly designing/building chips with Intel in the US** (stock +8-11% on this news); 18A-P process entering risk production on time; $20B+ raise saw $100B in institutional demand. Next earnings Oct 22 — ~6 weeks out, outside T1 horizon. | $100–106 (this week's low to current — a live test of weekly MA20 at 107.36) | ~$91–94 (1–1.5x daily ATR 5.38 below MA50 99.62) | ~$115–120 (~9-15% off entry) | $101.05, confirmed close 2026-09-16 4:00 PM EDT (+4.03%) | ✅ Filled, see Current Holdings above — held INSIDE the entry zone ($100-106) into the close; stop (~$91-94) gap holding ~7.5-10% | Weekly close above 107.36 (MA20), or daily close above EMA10 |
...
| **INTC** | $101.6173 (0.15 fractional sh, $15.24) | $101.05, confirmed close 2026-09-16 4:00 PM EDT (+4.03%) | -0.56% | ~$91–94 (no automated stop — same fractional-share gap) | Full exit at T1 ~$115–120 per this account's T1-exit rule | ✅ Held essentially at cost basis into the close. Stop gap ~7.5-10%, clear. |
...
| **PLTR** | $171.13 (0.07 fractional sh, $11.98) | $174.34, confirmed close 2026-09-16 4:00 PM EDT (+1.03%) | +1.88% | ~$161–165 (1–1.5x daily ATR7.44 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$205–208 per this account's T1-exit rule | 🟢 First green close since the fill. Stop gap widened to ~5.4-5.7%, clear. Fresh, convergent catalyst intact (3 analyst target raises within days). |
| **NBIS** | $214.20 (0.05 fractional sh, $10.71) | $209.37, confirmed close 2026-09-16 4:00 PM EDT (+0.96%) | -2.26% | ~$196–205 (1–1.5x daily ATR18.53 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$250–255 per this account's T1-exit rule | ⚠️ Stop gap TIGHTENED to ~2.1% into the close (was ~4.2% at fill). After-hours popped to $223.58 (+6.79%) same session — if that holds at tomorrow's open the gap widens back out, but not confirmed. Worth a check before assuming safety. |
| **HOOD** | $105.96 (0.1 fractional sh, $10.60) | $104.42, confirmed close 2026-09-16 4:00 PM EDT (-5.46%) | -1.45% | ~$99–102 (1–1.5x daily ATR6.44 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$135–138 per this account's T1-exit rule | ⚠️ Closed down further than the fill, stop gap now only ~2.3% at the near bound ($102) — the tightest position on this account. Sector-correlated drop (COIN regulatory news), not yet a company-specific breakdown, but this needs a check first thing tomorrow. |
