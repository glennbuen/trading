...
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | **INTC** | Trend reversal/continuation | Swing | Short-term (T1 exit) | Strongest catalyst reviewed so far — multiple concrete confirmed events, not sentiment: **US government holds a 10% stake**; Nvidia investing $5B to co-develop custom x86 CPUs + $8.9B government investment; **Apple reportedly designing/building chips with Intel in the US** (stock +8-11% on this news); 18A-P process entering risk production on time; $20B+ raise saw $100B in institutional demand. Next earnings Oct 22 — ~6 weeks out, outside T1 horizon. | $100–106 (this week's low to current — a live test of weekly MA20 at 107.36) | ~$91–94 (1–1.5x daily ATR 5.38 below MA50 99.62) | ~$115–120 (~9-15% off entry) | $121.78, confirmed close 2026-09-21 4:00 PM EDT (+12.14%) | 🔴 Filled, see Current Holdings above — **T1 ($115-120) CLEARED, now +19.85% unrealized.** Per this account's T1-only exit rule, this is a real decision point. | Weekly close above 107.36 (MA20), or daily close above EMA10 |
...
| 4 | **TSM** | Trend pullback/continuation | Swing | Short-term (T1 exit) | Extremely strong, consistent (not one-quarter) growth: Aug revenue +53.3% YoY, Q2 2026 revenue +36%/net income +77.4% YoY, Q3 guidance $44.6-45.8B rev at 65-67% gross margin. AI chip demand outstripping supply. Next earnings ~mid-October, moderate distance out. | $420–425 (daily MA50/MA20/EMA10 cluster, current price only ~2.5-3.5% above — close to live) | ~$403–409 (1–1.5x daily ATR 11.49 below zone) | ~$460–475 (~9-13% off entry, approaching 52w high 479.00) | $445.14, confirmed close 2026-09-21 4:00 PM EDT (+2.41%) | 🟢 Extending above the $420-425 zone; stop (~$403-409) gap ~8.1-9.4% | Next daily candle no fresh low, or close back above EMA10 |
...
| **INTC** | $101.6173 (0.15 fractional sh, $15.24) | $121.78, confirmed close 2026-09-21 4:00 PM EDT (+12.14%) | +19.85% | ~$91–94 (no automated stop — same fractional-share gap) | Full exit at T1 ~$115–120 per this account's T1-exit rule | 🔴 **T1 ($115-120) has been CLEARED — close is now $121.78, above the entire target range.** Per this account's T1-only full-exit rule ("trader not investor"), this is the signal to take the full exit, not hold for more. A real decision point, not a routine update. |
...
| **PLTR** | $171.13 (0.07 fractional sh, $11.98) | $183.09, confirmed close 2026-09-21 4:00 PM EDT (+3.07%) | +6.99% | ~$161–165 (1–1.5x daily ATR7.44 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$205–208 per this account's T1-exit rule | 🟢 Fourth green close running. Stop gap ~9.9-12.1%, clear. ~11-13% below T1. |
| **NBIS** | $214.20 (0.05 fractional sh, $10.71) | $232.80, confirmed close 2026-09-21 4:00 PM EDT (+4.14%) | +8.68% | ~$196–205 (1–1.5x daily ATR18.53 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$250–255 per this account's T1-exit rule | 🟢 Third green close running. Stop gap ~11.9-15.8%, clear. ~7-9% below T1. |
| **HOOD** | $105.96 (0.1 fractional sh, $10.60) | $123.30, confirmed close 2026-09-21 4:00 PM EDT (+2.90%) | +16.36% | ~$99–102 (1–1.5x daily ATR6.44 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$135–138 per this account's T1-exit rule | 🟢 Still the best performer, third straight green close. Stop gap ~19.7-24.5%. Only ~9.5-11.9% below T1 ($135-138) now. |
| **MSFT** | $493.81 (0.03 fractional sh, $14.81, real fill, 2026-09-21) | $501.61, confirmed close 2026-09-21 4:00 PM EDT (+1.59%) | +1.58% | ~$477–482 (1–1.5x daily ATR10.66 below the original zone, set at the same review this position was flagged from) | Full exit at T1 ~$540–554 per this account's T1-exit rule | 🟢 Filled right inside the stated $492-497 zone, exactly as planned. Closed above the whole zone the same session — a strong start. Stop gap ~3.9-4.9%. |
