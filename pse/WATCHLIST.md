...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | **ICT** | Trend pullback (cleanest yet) | Uptrend continuation | Short-term + long-term candidate | Both | First PSE co. past ₱2T mkt cap; Mexico terminal expansion; "Strong Buy," 13 analysts, target ₱1,099 | ₱947–962 (pullback zone) | ₱900–915 (ATR-confirmed, corrected 2026-09-10 from ₱938–942) | T1 ₱1,000 · T2 (52w high) ₱1,049 | ₱913.00, real intraday 2026-09-18 11:15 AM (-2.35%) | 293,900 sh | ✅ **Filled 2026-09-18, 10 sh @ ₱915**, see Current Holdings above — bought at the old stop level, not the ₱947-962 zone. Near-zero stop cushion, flagged directly. | Moot now — position filled |
| 2 | **NIKL** | Trend pullback | Swing / Uptrend continuation | Short-term (T1 full-exit rule applies — see below) | Short-term | H1 2026 NI +93% YoY to ₱4.06B (Aug 7 report), EBITDA +67%; tight nickel supply/demand tailwind, analyst target ₱5.53 | ₱4.25–4.45 | ₱3.90–3.95 | T1 ₱5.20–5.40 (full exit here, not partial) | ₱4.22, real intraday 2026-09-18 11:15 AM (+0.24%) | 617,000 sh | ✅ **Starter FILLED** (1,000 sh @ ₱4.6738 avg) — real bounce today, stop gap widened back out to ~6.8-8.0% | Next candle not making a fresh low vs. today confirms full conviction; deeper zone ₱4.25–4.45 was the confirmation-add trigger, moot now that the starter already filled in the shallow zone |
| 3 | **OGP** | Trend pullback | Uptrend continuation | Short-term + long-term candidate | Both | Didipio mine life extended to 2037; $1.958B long-term investment confirmed; solid 2026 production guidance | ₱34.20–36.65 | ₱32.60–33.15 (ATR-confirmed, close to original ₱33.50 guess) | T1 ₱40.00 · T2 (52w high) ₱40.50 | ₱36.60, real intraday 2026-09-18 02:05 PM (-0.68%) | 337,700 sh | ✅ **Filled 2026-09-18, 100 sh @ ₱36.65**, see Current Holdings above — a clean fill right at the top of the entry zone | Moot now — position filled |
| 4 | **APX** | Trend pullback | Quick (was Uptrend — broke to new highs, pullback already over) | Short-term + long-term candidate | Both | H1 2026 NI +68% YoY, Q1 EPS +92%; analyst target ₱22.00, above the new 52w high | ₱15.50–15.80 (deep) · ₱16.30–16.50 (shallow) | **Trail ~₱16.30–16.40** (fresh ATR-confirmed 2026-09-11, 1.5x ATR14=0.80 below the recent swing low, confluence with MA20 16.16 — no longer a rough estimate) | T1 ✅ hit · T2 ✅ hit · **T3 (new) ₱19.70–20.00**, trail don't hold | ₱19.00, **confirmed close 2026-09-18 3:00 PM** (+3.71%) | 1,329,200 sh | ✅ Real strength today, trail (₱16.30–16.40) still has real room — ~14.2% below current | N/A — already well past entry, managing the existing run |
| 5 | **Philweb (WEB)** | Trend pullback | Quick (momentum chase — never gave a pullback) | Short-term only | Short-term | Q2 swung to profit, rev +96%; ₱2.02B + ₱4.23B capital injections (Gokongwei, JKS stake) | ₱14.20–14.45 | ₱13.50–13.70 | ₱16.00–16.50 | ₱14.50, **confirmed close 2026-09-18 3:00 PM** (-0.28%) | 307,800 sh | 🟡 Closed within ~0.3-2.1% of the ₱14.20–14.45 zone — still hasn't tested it | Would need to keep falling into ₱14.20–14.45, then a no-fresh-low candle |
| 6 | **CNPF** | Trend pullback (weekly still unconfirmed) | Swing | Short-term (T1 full-exit rule applies) | Short-term | H1 2026 NI +6% YoY (₱4.14B), rev +15%; analyst "Strong Buy" (9), target ₱41.58 — but a month-old print, not fresh news behind Friday's move | ₱32.37–32.48 (EMA10/MA20 daily) | ₱31.00–31.20 (ATR-confirmed) | T1 ₱34.60–34.70 (weekly MA50/daily MA200 confluence, full exit) | ₱32.90, **confirmed close 2026-09-18 3:00 PM** (+1.23%) | 304,000 sh | 🟢 Closed above the ₱32.37-32.48 zone, real strength | Next candle not making a fresh low vs. today confirms the starter — but only once it's backed by real volume, not a repeat of today's thin tape; weekly close above 33.62 (weekly MA200) would strengthen the read further |
...
| **NIKL** | ₱4.6738 (real fill, 1,000 sh, 2026-09-11) | ₱4.28, **confirmed close 2026-09-18 3:00 PM** (+1.66%) | 617,000 sh | -8.42% | H1 2026 NI +93% YoY to ₱4.06B, EBITDA +67%; tight nickel supply/demand tailwind | N/A — **T1-full-exit rule applies** (trader-not-investor, no partial take — see Exit methodology) | **Initial stop ₱3.90–3.95 active** (ATR-based, ~1.5x ATR14 below MA50) — gap ~6.7-7.6% | **Fresh chart confirms 2026-09-11**: a pullback off a local top (~4.9-5.0), not a trend break — still above MA20/50/200, RSI cooled from overbought (70.39→59.20), which is healthy, not alarming. See full [NIKL entry](#nickel-asia-corp-nikl) below. Still just the Starter — price hasn't reached the ₱4.25–4.45 confirmation-add zone yet. |
| **ICT** | ₱915.00 (10 sh, real fill, 2026-09-18) | ₱905.00, **confirmed close 2026-09-18 3:00 PM** (-3.21%) | 415,830 sh | -1.09% | First PSE co. past ₱2T mkt cap; Mexico terminal expansion; "Strong Buy," 13 analysts, target ₱1,099 | N/A — no partial-take rule set yet for this position | **🔴 Kept at ₱900–915 (user's explicit choice, 2026-09-18) — today's close (₱905.00) is now INSIDE that stop zone.** Revisited 2026-09-18: two data-grounded alternatives were presented (a tight stop ~₱895-900 just below today's low, or a structural stop ~₱870-875 below the real 1-month low of ₱881.00, buying real room instead of a level likely to get clipped by normal noise) — **user chose to keep the original ₱900-915 plan as-is.** Checking again Monday (2026-09-21, next trading session) with fresh data. | Bought right at what this account's own prior analysis called the stop level, not inside the ₱947-962 pullback zone. Real catalyst on file (US government 10% stake, Nvidia $5B investment, Apple chip partnership), but the entry timing here doesn't match this account's usual staged-pullback pattern. |
| **OGP** | ₱36.65 (100 sh, real fill, 2026-09-18) | ₱36.85, **confirmed close 2026-09-18 3:00 PM** (0.00%, flat) | 337,700 sh | +0.55% | Didipio mine life extended to 2037; $1.958B long-term investment confirmed; solid 2026 production guidance | N/A — no partial-take rule set yet for this position | ₱32.60–33.15 (ATR-confirmed, from the original setup) — gap ~9.5-11.0%, real room, a clean zone fill | Filled right at the top of the stated ₱34.20-36.65 entry zone — a standard, well-fitting entry, unlike ICT's fill today. |
| **DMC** | ₱7.9329 (700 sh, real weighted avg: 100 sh @ ₱7.95 + 600 sh @ ₱7.93, 2026-09-18) | ₱8.10, **confirmed close 2026-09-18 3:00 PM** (-1.94%) | 4,732,700 sh | +2.11% | Softer: Q1 NI -2% YoY, FY25 NI -21%; fair value cut ₱10.04→9.42 — tempers the thesis | N/A — no partial-take rule set yet for this position | ₱7.57–7.67 (ATR-confirmed, from the original setup) — gap ~3.3-4.6%, tighter than OGP but a legitimate in-zone fill | Both fills landed cleanly inside the stated ₱7.86-8.02 entry zone — a standard staged entry, though the weakest fundamental story of today's three fills (softer Q1/FY25 numbers, fair value already cut). |
