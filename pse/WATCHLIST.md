...
handful of trades, low share count) means the quoted price is not
real price discovery and any technical signal built on it (a zone
touch, a stop test) should be flagged as unreliable until real volume
shows up. This was prompted by a real catch on CNPF (only 400 shares
traded when its price appeared to test its entry zone) and confirmed
AEV was in the same thin-volume situation (600 shares) the same
session. **Added 2026-09-11: also flag,
...
| Rank | Symbol | Tier | **Play type** | Horizon | **Recommended** | **Catalyst** | Entry range | Stop-loss | Take-profit | Current price | Volume today | Status | What confirms the add |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | **ICT** | Trend pullback (cleanest yet) | Uptrend continuation | Short-term + long-term candidate | Both | First PSE co. past ₱2T mkt cap; Mexico terminal expansion; "Strong Buy," 13 analysts, target ₱1,099 | ₱947–962 (pullback zone) | ₱900–915 (ATR-confirmed, corrected 2026-09-10 from ₱938–942) | T1 ₱1,000 · T2 (52w high) ₱1,049 | ₱919.00, real intraday 2026-09-21 10:30 AM (+1.55%) | 319,690 sh | 🟢 **Filled 2026-09-18, 10 sh @ ₱915**, see Current Holdings above — recovered back above the fill price and the stop zone Monday morning, now +0.44% unrealized. Stop cushion still thin (~0.4-2.1%) but improved. | Moot now — position filled |
| 2 | **NIKL** | Trend pullback | Swing / Uptrend continuation | Short-term (T1 full-exit rule applies — see below) | Short-term | H1 2026 NI +93% YoY to ₱4.06B (Aug 7 report), EBITDA +67%; tight nickel supply/demand tailwind, analyst target ₱5.53 | ₱4.25–4.45 | ₱3.90–3.95 | T1 ₱5.20–5.40 (full exit here, not partial) | ₱4.24, real intraday 2026-09-21 10:30 AM (-0.93%) | 202,000 sh | ✅ **Starter FILLED** (1,000 sh @ ₱4.6738 avg) — real bounce today, stop gap widened back out to ~6.8-8.0% | Next candle not making a fresh low vs. today confirms full conviction; deeper zone ₱4.25–4.45 was the confirmation-add trigger, moot now that the starter already filled in the shallow zone |
| 3 | **OGP** | Trend pullback | Uptrend continuation | Short-term + long-term candidate | Both | Didipio mine life extended to 2037; $1.958B long-term investment confirmed; solid 2026 production guidance | ₱34.20–36.65 | ₱32.60–33.15 (ATR-confirmed, close to original ₱33.50 guess) | T1 ₱40.00 · T2 (52w high) ₱40.50 | ₱36.60, real intraday 2026-09-21 10:30 AM (-0.68%) | 42,100 sh | ✅ **Filled 2026-09-18, 100 sh @ ₱36.65**, see Current Holdings above — a clean fill right at the top of the entry zone | Moot now — position filled |
| 4 | **APX** | Trend pullback | Quick (was Uptrend — broke to new highs, pullback already over) | Short-term + long-term candidate | Both | H1 2026 NI +68% YoY, Q1 EPS +92%; analyst target ₱22.00, above the new 52w high | ₱15.50–15.80 (deep) · ₱16.30–16.50 (shallow) | **Trail ~₱16.30–16.40** (fresh ATR-confirmed 2026-09-11, 1.5x ATR14=0.80 below the recent swing low, confluence with MA20 16.16 — no longer a rough estimate) | T1 ✅ hit · T2 ✅ hit · **T3 (new) ₱19.70–20.00**, trail don't hold | ₱19.12, real intraday 2026-09-21 10:30 AM (+0.63%) | 2,224,300 sh | ✅ Holding Friday's strength, trail (₱16.30–16.40) still has real room — ~14.7% below current | N/A — already well past entry, managing the existing run |
| 5 | **Philweb (WEB)** | Trend pullback | Quick (momentum chase — never gave a pullback) | Short-term only | Short-term | Q2 swung to profit, rev +96%; ₱2.02B + ₱4.23B capital injections (Gokongwei, JKS stake) | ₱14.20–14.45 | ₱13.50–13.70 | ₱16.00–16.50 | ₱14.26, real intraday 2026-09-21 11:18 AM (-1.66%) | 405,800 sh | ✅ **Filled 2026-09-21, 400 sh @ ₱14.22**, see Current Holdings above — near the lower part of the zone, exactly as planned | Moot now — position filled |
| 6 | **CNPF** | Trend pullback (weekly still unconfirmed) | Swing | Short-term (T1 full-exit rule applies) | Short-term | H1 2026 NI +6% YoY (₱4.14B), rev +15%; analyst "Strong Buy" (9), target ₱41.58 — but a month-old print, not fresh news behind Friday's move | ₱32.37–32.48 (EMA10/MA20 daily) | ₱31.00–31.20 (ATR-confirmed) | T1 ₱34.60–34.70 (weekly MA50/daily MA200 confluence, full exit) | ₱32.50, real intraday 2026-09-21 10:30 AM (-1.22%) | ⚠️ 2,100 sh — thin again, same caveat as before | 🟡 Pulled back to just above the ₱32.37-32.48 zone, but on very thin volume — don't trust this print any more than the earlier one | Next candle not making a fresh low vs. today confirms the starter — but only once it's backed by real volume, not a repeat of today's thin tape; weekly close above 33.62 (weekly MA200) would strengthen the read further |
| 7 | **BPI** | Trend pullback | Swing | Short-term | Short-term | Q1 miss vs forecast but +1.7% YoY NI; 2026 outlook targets high-single-digit growth | ₱102.50–104.00 | ₱101.00–101.50 | T1 ₱108–109 · T2 ₱114–115 | ₱101.00 (day of the stop-out) | — (closed) | ✅ **CLOSED 2026-09-16 — stopped out at ₱100.90, plan executed as designed.** No longer an open position; would need a fresh setup (new zone, new stop) to be reconsidered, not just a return to the old entry range. | Moot — position closed |
| 8 | **BLOOM** | Speculative bottom-fish | Bottomfishing | Short-term, smallest size | Short-term | Q2 loss narrowed sharply (₱1.41B→₱345M YoY), EBITDA +35%, GGR +15% | ₱2.17–2.32 | ₱2.05–2.10 | T1 ₱2.45 · T2 ₱2.60 | ₱2.08 (fill price) | — (closed) | ✅ **CLOSED 2026-09-16 — stopped out at ₱2.08, same day as BPI, plan executed as designed.** No longer an open position; would need a fresh setup to be reconsidered. | Moot — position closed |
| 9 | **DMC** | Speculative bottom-fish | Bottomfishing | Short-term entry, long-term candidate on fundamentals | Short-term (long-term on fundamentals) | Softer: Q1 NI -2% YoY, FY25 NI -21%; fair value cut ₱10.04→9.42 — tempers the thesis | ₱7.86–8.02 | ₱7.57–7.67 (ATR-confirmed) | T1 ₱9.50–9.71 · T2 ₱10.65–11.00 | ₱8.09, real intraday 2026-09-21 10:30 AM (-0.12%) | 239,700 sh | ✅ **Filled 2026-09-18, 700 sh (100 @ ₱7.95 + 600 @ ₱7.93)**, see Current Holdings above — filled cleanly inside the zone as the fade from Wednesday's peak continued down into it | Moot now — position filled |
| 10 | **AEV** | Trend reversal (weekly MA200 overhang, ~5.5% above price — corrects the "clean uptrend" read from the initial MA-only screen) | Swing | Short-term entry now; long-term contingent on clearing weekly resistance | Short-term (contingent long-term) | H1 2026 net income **+63% YoY to ₱13.6B** (Q2 alone +40% YoY); AboitizPower expanded its renewable portfolio (797MW Caliraya-Botocan-Kalayaan hydro + new solar), UnionBank contributed ₱3.4B; active share buyback program; strong balance sheet (₱86.6B cash, net debt/equity 0.9x); P/E 8.89, div yield 4.06% | ₱36.95–37.70 (daily MA20/EMA10/VWAP cluster) | ₱35.55–36.15 (1–1.5x daily ATR14=1.11 below the cluster, confluence with daily MA50 35.58) | T1 ₱38.95–39.79 (52w high / weekly MA200 confluence — **weak R:R, ~1.1:1, flagged not hidden**); T2 undefined until a clean weekly break above 39.79 gives something to target | ₱37.20, real intraday 2026-09-21 10:30 AM (+0.68%) | 29,600 sh | 🟢 Back inside the entry zone (₱36.95–37.70) — a reversal-off-a-real-decline setup (52w range ₱23.90–38.95), not a clean established-uptrend pullback | Next daily candle no fresh low vs. today, but the more meaningful confirmation is a weekly close above ₱39.79 (MA200) |
| 11 | **AP** | **Corrected 2026-09-15 — Range-bound near the top of a 5-month consolidation, not a clean uptrend continuation** (see re-review below; matches COL Financial's own SIDEWAYS/LIGHTEN rating, previously an unresolved disagreement) | Range trade | Short-term entry only, long-term case weakened | Short-term | AboitizPower H1 2026 net income **+45% YoY to ₱18.4B** — real, but not enough on its own to override the technical caution below. | ₱44.55–45.35 (daily MA20/EMA10/VWAP cluster) | ₱42.30–42.80 (1–1.5x daily ATR14=0.91 below daily MA50/MA200 cluster ~43.7) | T1 ₱48.00 (the top of the range it's failed to break for 5 months, not a fresh breakout target — R:R ~1.2:1, weaker than it looks) | ₱45.15, real intraday 2026-09-21 10:30 AM (-1.85%) | 385,900 sh | 🟡 Pulled back below the zone top (₱45.35), still well below the ₱48.00 range top this name has failed to break for 5 months. Same distribution caution still applies: net foreign selling (NFB/s -8.24M), weekly MACD line below its own signal, RSI parked at 51.94 daily/55.29 weekly (neutral, not trending) | A genuine breakout above ₱48 (the range top) on strong volume — the current MA-cluster touch is not, by itself, confirmation of anything in a range-bound name |
...
- **AEV** (new 2026-09-14): H1 2026 net income **+63% YoY to ₱13.6B**
  ...
  **buying back shares** and adding to its AboitizPower/UnionBank
  ...
  table detail.
- **AP** (new 2026-09-14): H1 2026 net income **+45% YoY to ₱18.4B**
  ([Manila Bulletin](https://mb.com.ph/2026/07/29/aboitizpower-posts-18-billion-net-income-as-renewable-drive-pays-off)) —
  improved market prices, additional hydro/gas contributions, and
  fresh output from newly completed solar plants (221MWp Olongapo,
  47MWp Armenia, 93MWp San Manuel) more than offset lower coal-fired
  availability. ₱62B allocated for 2026 capex, prioritizing renewables
  and battery storage. This is the same underlying business driving
  AEV's own H1 strength (AP contributed ₱10B of AEV's ₱13.6B) — real,
  substantive growth, but correlated with the AEV thesis above, not
  independent of it.
...
| Symbol | Cost basis (real) | Current price | Volume today | Unrealized | **Catalyst** | Partial take done? | Trailing stop (remainder) | Technical read |
|---|---|---|---|---|---|---|---|---|
| **LTG** | ₱11.333 (900 sh, real avg) | ₱15.04, real intraday 2026-09-21 10:30 AM (-0.53%) | 156,700 sh | +32.71% | Q2 NI +24% YoY, rev +6.3%; dividend just paid (ex-date Sep 7), 8.2% yield | ✅ 30% sold at +20% | ₱14.29–14.52 (weekly ATR-based, 1–1.5x ATR14=0.46) — still above, gap to the top of the trail ~3.7%. **Decision confirmed 2026-09-17 (user): leave as-is, no new partial take. If the trail (₱14.29–14.52) is hit, sell the FULL remaining position (900 sh, as shown in Cost basis — already net of the 30%-at-+20% take from 2026-09-10) — not another partial.** Made explicitly after naming the "it might go higher" pattern that kept SCC held too long; this is the pre-committed rule meant to remove that decision from the moment it actually matters. | Genuine multi-year weekly uptrend (recovered from ~₱8-9 in 2022-23), now testing its own 2021 high — a confirmed weekly close above that old high would be a real breakout signal. Daily RSI neutral (50.3), weekly RSI neutral (52.2) — room to continue, not extended. |
| ~~**SCC**~~ | ~~₱37.7423 (was 1,600 sh)~~ | **✅ CLOSED 2026-09-17 — fully exited, sold in three tranches** | — (closed) | **-29,947.68 total realized loss (gross, all three sales)** | Coal-block auction risk dominates — but see the fresh, contradictory news flagged in the Trade Journal | ✅ Fully closed: 800 sh @ ₱17.90 (2026-09-11), 400 sh @ ₱20.25 (2026-09-17), 400 sh @ ₱20.05 (2026-09-17, final) | — (position closed) | No longer an open position — sold ahead of the "revisit tomorrow" plan stated for the last 400 sh earlier the same day. Full detail in `TRADE_JOURNAL.md`. Would need a fresh setup (new zone, new stop) to be reconsidered — same standing rule as BPI/BLOOM. |
| ~~**BLOOM**~~ | ~~₱2.2567~~ | **✅ CLOSED 2026-09-16 — stopped out** | — (closed) | **-7.83%** | Q2 loss narrowed sharply (₱1.41B→₱345M YoY), EBITDA +35%, GGR +15% | N/A — closed at a loss | — | Sold 1,000 sh @ ₱2.08, same day as BPI's stop-out — second successful execution that session. Realized loss ≈ -₱176.70 gross. Full detail in `TRADE_JOURNAL.md`. No longer a position to monitor. |
| ~~**BPI**~~ | ~~₱103.6050~~ | **✅ CLOSED 2026-09-16 — stopped out** | — (closed) | **-2.61%** | Q1 miss vs forecast but +1.7% YoY NI | N/A — closed at a loss, not a partial take | — | Sold 20 sh @ ₱100.90, market order, same day the stop broke. Realized loss ≈ -₱54.10 gross. Full detail in `TRADE_JOURNAL.md`. No longer a position to monitor. |
| **NIKL** | ₱4.6738 (real fill, 1,000 sh, 2026-09-11) | ₱4.24, real intraday 2026-09-21 10:30 AM (-0.93%) | 202,000 sh | -9.28% | H1 2026 NI +93% YoY to ₱4.06B, EBITDA +67%; tight nickel supply/demand tailwind | N/A — **T1-full-exit rule applies** (trader-not-investor, no partial take — see Exit methodology) | **Initial stop ₱3.90–3.95 active** (ATR-based, ~1.5x ATR14 below MA50) — gap ~6.7-7.6% | **Fresh chart confirms 2026-09-11**: a pullback off a local top (~4.9-5.0), not a trend break — still above MA20/50/200, RSI cooled from overbought (70.39→59.20), which is healthy, not alarming. See full [NIKL entry](#nickel-asia-corp-nikl) below. Still just the Starter — price hasn't reached the ₱4.25–4.45 confirmation-add zone yet. |
| **ICT** | ₱915.00 (10 sh, real fill, 2026-09-18) | ₱919.00, real intraday 2026-09-21 10:30 AM (+1.55%) | 319,690 sh | +0.44% | First PSE co. past ₱2T mkt cap; Mexico terminal expansion; "Strong Buy," 13 analysts, target ₱1,099 | N/A — no partial-take rule set yet for this position | **🟢 Monday check, as planned: price recovered back above both the entry (₱915) and the ₱900-915 stop zone entirely.** Gap to the stop is still thin (~0.4-2.1%) but the position is genuinely in the green for the first time since the fill. The near-zero-cushion risk hasn't disappeared, just improved. | Bought right at what this account's own prior analysis called the stop level, not inside the ₱947-962 pullback zone. Real catalyst on file (US government 10% stake, Nvidia $5B investment, Apple chip partnership), but the entry timing here doesn't match this account's usual staged-pullback pattern. |
| **OGP** | ₱36.65 (100 sh, real fill, 2026-09-18) | ₱36.60, real intraday 2026-09-21 10:30 AM (-0.68%) | 42,100 sh | -0.14% | Didipio mine life extended to 2037; $1.958B long-term investment confirmed; solid 2026 production guidance | N/A — no partial-take rule set yet for this position | ₱32.60–33.15 (ATR-confirmed, from the original setup) — gap ~9.5-11.0%, real room, a clean zone fill | Filled right at the top of the stated ₱34.20-36.65 entry zone — a standard, well-fitting entry, unlike ICT's fill today. |
| **DMC** | ₱7.9329 (700 sh, real weighted avg: 100 sh @ ₱7.95 + 600 sh @ ₱7.93, 2026-09-18) | ₱8.09, real intraday 2026-09-21 10:30 AM (-0.12%) | 239,700 sh | +1.98% | Softer: Q1 NI -2% YoY, FY25 NI -21%; fair value cut ₱10.04→9.42 — tempers the thesis | N/A — no partial-take rule set yet for this position | ₱7.57–7.67 (ATR-confirmed, from the original setup) — gap ~3.3-4.6%, tighter than OGP but a legitimate in-zone fill | Both fills landed cleanly inside the stated ₱7.86-8.02 entry zone — a standard staged entry, though the weakest fundamental story of today's three fills (softer Q1/FY25 numbers, fair value already cut). |
| **WEB** | ₱14.22 (400 sh, real fill, 2026-09-21) | ₱14.26, real intraday 2026-09-21 11:18 AM (-1.66%) | 405,800 sh | +0.28% | Q2 swung to profit, rev +96%; ₱2.02B + ₱4.23B capital injections (Gokongwei, JKS stake) | N/A — no partial-take rule set yet for this position | ₱13.50–13.70 (from the original setup) — gap ~3.9-5.3% | Filled near the lower part of the stated ₱14.20-14.45 entry zone, exactly as planned — a clean zone entry, same category as OGP/DMC. |
...
- **AREIT (AREIT Inc.)** (2026-09-14, ₱37.20) — **the initial
  MA5/20/50/100 screen misread this one, worth being explicit about**:
  it flagged tight MA convergence (all four daily MAs within centavos
  of price) as "worth a closer look," the same signal that correctly
  flagged AEV and AP as live entries. The real chart shows the opposite
  story here — daily MA200 (39.97) sits ~7.4% *above* current price,
  and the weekly MA50 (40.27) is well above too, with weekly MA200
  (37.44) sitting almost exactly at price. This is a stock that peaked
  (~₱45 around Oct 2025-Jan 2026 per the visual chart), declined
  sharply, and has been flat-consolidating for months in a ₱36-38
  shelf — the short-term MAs converged with price *during that
  consolidation*, not because price pulled back into an active
  uptrend. Weekly RSI 42.22, below midline; NFB/s -2.04M (net foreign
  selling). Real dividend yield (6.69%) and reasonable P/E (12.91) make
  it a legitimate income holding, but not a swing/pullback setup by
  this project's standard. **The lesson, stated plainly**: MA
  convergence alone doesn't distinguish "healthy pullback in an
