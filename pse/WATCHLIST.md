...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | **ICT** | Trend pullback (cleanest yet) | Uptrend continuation | Short-term + long-term candidate | Both | First PSE co. past ₱2T mkt cap; Mexico terminal expansion; "Strong Buy," 13 analysts, target ₱1,099 | ₱947–962 (pullback zone) | ₱900–915 (ATR-confirmed, corrected 2026-09-10 from ₱938–942) | T1 ₱1,000 · T2 (52w high) ₱1,049 | ₱900.00 (exit price) | — (closed) | ✅ **CLOSED 2026-09-21 — stopped out at ₱900, the bottom of the ₱900-915 stop zone kept from Monday's review.** Realized loss ≈ -₱150 gross (-1.64%). No longer an open position; would need a fresh setup to be reconsidered. | Moot — position closed |
| 2 | **NIKL** | Trend pullback | Swing / Uptrend continuation | Short-term (T1 full-exit rule applies — see below) | Short-term | H1 2026 NI +93% YoY to ₱4.06B (Aug 7 report), EBITDA +67%; tight nickel supply/demand tailwind, analyst target ₱5.53 | ₱4.25–4.45 | ₱3.90–3.95 | T1 ₱5.20–5.40 (full exit here, not partial) | ₱4.15, real intraday 2026-09-22 1:50 PM (+0.24%) | 1,239,000 sh | ✅ **Starter FILLED** (1,000 sh @ ₱4.6738 avg) — gap ~4.8-6.0% | Next candle not making a fresh low vs. today confirms full conviction; deeper zone ₱4.25–4.45 was the confirmation-add trigger, moot now that the starter already filled in the shallow zone |
| 3 | **OGP** | Trend pullback | Uptrend continuation | Short-term + long-term candidate | Both | Didipio mine life extended to 2037; $1.958B long-term investment confirmed; solid 2026 production guidance | ₱34.20–36.65 | ₱32.60–33.15 (ATR-confirmed, close to original ₱33.50 guess) | T1 ₱40.00 · T2 (52w high) ₱40.50 | ₱35.50, real intraday 2026-09-22 1:50 PM (-2.87%) | 455,900 sh | ✅ **Filled 2026-09-18, 100 sh @ ₱36.65; added 100 sh 2026-09-21 @ ₱36.40**, see Current Holdings above — 200 sh total, weighted avg ₱36.525, both fills inside the entry zone | Moot now — position filled |
| 4 | **APX** | Trend pullback | Quick (was Uptrend — broke to new highs, pullback already over) | Short-term + long-term candidate | Both | H1 2026 NI +68% YoY, Q1 EPS +92%; analyst target ₱22.00, above the new 52w high | ₱15.50–15.80 (deep) · ₱16.30–16.50 (shallow) | **Trail ~₱16.30–16.40** (fresh ATR-confirmed 2026-09-11, 1.5x ATR14=0.80 below the recent swing low, confluence with MA20 16.16 — no longer a rough estimate) | T1 ✅ hit · T2 ✅ hit · **T3 (new) ₱19.70–20.00**, trail don't hold | ₱18.38, real intraday 2026-09-22 1:50 PM (-1.50%) | 3,141,200 sh | ✅ Pulled back, trail (₱16.30–16.40) still has real room — ~11.0% below current | N/A — already well past entry, managing the existing run |
| 5 | **Philweb (WEB)** | Trend pullback | Quick (momentum chase — never gave a pullback) | Short-term only | Short-term | Q2 swung to profit, rev +96%; ₱2.02B + ₱4.23B capital injections (Gokongwei, JKS stake) | ₱14.20–14.45 | ₱13.50–13.70 | ₱16.00–16.50 | ₱14.10, real intraday 2026-09-22 1:50 PM (-1.12%) | 691,800 sh | ✅ **Filled 2026-09-21, 400 sh @ ₱14.22**, see Current Holdings above — essentially flat, holding above the zone floor | Moot now — position filled |
| 6 | **CNPF** | Trend pullback (weekly still unconfirmed) | Swing | Short-term (T1 full-exit rule applies) | Short-term | H1 2026 NI +6% YoY (₱4.14B), rev +15%; analyst "Strong Buy" (9), target ₱41.58 — but a month-old print, not fresh news behind Friday's move | ₱32.37–32.48 (EMA10/MA20 daily) | ₱31.00–31.20 (ATR-confirmed) | T1 ₱34.60–34.70 (weekly MA50/daily MA200 confluence, full exit) | ₱32.80, real intraday 2026-09-22 1:50 PM (0.00%) | 205,700 sh | 🟡 Pulled back to just above the ₱32.37-32.48 zone, volume built up through the session — no longer thin | Next candle not making a fresh low vs. today confirms the starter — but only once it's backed by real volume, not a repeat of today's thin tape; weekly close above 33.62 (weekly MA200) would strengthen the read further |
...
| **NIKL** | ₱4.6738 (real fill, 1,000 sh, 2026-09-11) | ₱4.15, real intraday 2026-09-22 1:50 PM (+0.24%) | 1,239,000 sh | -11.20% | H1 2026 NI +93% YoY to ₱4.06B, EBITDA +67%; tight nickel supply/demand tailwind | N/A — **T1-full-exit rule applies** (trader-not-investor, no partial take — see Exit methodology) | **Initial stop ₱3.90–3.95 active** (ATR-based, ~1.5x ATR14 below MA50) — gap ~4.8-6.0% | **Fresh chart confirms 2026-09-11**: a pullback off a local top (~4.9-5.0), not a trend break — still above MA20/50/200, RSI cooled from overbought (70.39→59.20), which is healthy, not alarming. See full [NIKL entry](#nickel-asia-corp-nikl) below. Still just the Starter — price hasn't reached the ₱4.25–4.45 confirmation-add zone yet. |
| ~~**ICT**~~ | ~~₱915.00 (10 sh)~~ | **✅ CLOSED 2026-09-21 — stopped out at ₱900** | — (closed) | **-1.64%** | First PSE co. past ₱2T mkt cap; Mexico terminal expansion; "Strong Buy," 13 analysts, target ₱1,099 | N/A — closed at a loss | — (position closed) | Sold at the bottom of the ₱900-915 stop zone that was deliberately kept as-is after Monday's review. Realized loss ≈ -₱150 gross. Full detail in `TRADE_JOURNAL.md`. No longer a position to monitor — would need a fresh setup to be reconsidered. |
| **OGP** | ₱36.525 (200 sh, real weighted avg: 100 sh @ ₱36.65 + 100 sh @ ₱36.40, 2026-09-18/21) | ₱35.50, real intraday 2026-09-22 1:50 PM (-2.87%) | 455,900 sh | -2.81% | Didipio mine life extended to 2037; $1.958B long-term investment confirmed; solid 2026 production guidance | N/A — no partial-take rule set yet for this position | ₱32.60–33.15 (ATR-confirmed, from the original setup) — real pullback continuing, gap now ~6.6-8.2% | Added 100 sh 2026-09-21 @ ₱36.40, still within the original ₱34.20-36.65 entry zone — a straightforward average-down within the same zone, not a fresh confirmation signal. |
| **DMC** | ₱7.9329 (700 sh, real weighted avg: 100 sh @ ₱7.95 + 600 sh @ ₱7.93, 2026-09-18) | ₱7.75, real intraday 2026-09-22 1:50 PM (-1.40%) | 1,735,000 sh | -2.31% | Softer: Q1 NI -2% YoY, FY25 NI -21%; fair value cut ₱10.04→9.42 — tempers the thesis | N/A — no partial-take rule set yet for this position | ₱7.57–7.67 (ATR-confirmed, from the original setup) — **🔴 today's low (₱7.63) is still on record as INSIDE the stop zone — already tested once.** Current price ₱7.75 has recovered a bit further, gap now ~1.0-2.3%, but the intraday breach already happened. | Both fills landed cleanly inside the stated ₱7.86-8.02 entry zone at the time, but price has since fallen through the zone floor and tested the stop itself intraday — the weakest fundamental story of today's three fills (softer Q1/FY25 numbers, fair value already cut) is now showing up clearly in the price action. |
| **WEB** | ₱14.22 (400 sh, real fill, 2026-09-21) | ₱14.10, real intraday 2026-09-22 1:50 PM (-1.12%) | 691,800 sh | -0.84% | Q2 swung to profit, rev +96%; ₱2.02B + ₱4.23B capital injections (Gokongwei, JKS stake) | N/A — no partial-take rule set yet for this position | ₱13.50–13.70 (from the original setup) — gap ~3.9-5.3% | Filled near the lower part of the stated ₱14.20-14.45 entry zone, exactly as planned — a clean zone entry, same category as OGP/DMC. |
