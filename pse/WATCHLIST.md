...
| **OGP** | ₱36.525 (200 sh, real weighted avg: 100 sh @ ₱36.65 + 100 sh @ ₱36.40, 2026-09-18/21) | ₱36.70, real intraday 2026-09-22 10:06 AM (+0.41%) | 7,200 sh | +0.48% | Didipio mine life extended to 2037; $1.958B long-term investment confirmed; solid 2026 production guidance | N/A — no partial-take rule set yet for this position | ₱32.60–33.15 (ATR-confirmed, from the original setup) — gap ~9.0-10.5%, real room | Added 100 sh 2026-09-21 @ ₱36.40, still within the original ₱34.20-36.65 entry zone — a straightforward average-down within the same zone, not a fresh confirmation signal. |
| **DMC** | ₱7.9329 (700 sh, real weighted avg: 100 sh @ ₱7.95 + 600 sh @ ₱7.93, 2026-09-18) | ₱7.71, real intraday 2026-09-22 10:06 AM (-1.91%) | 470,900 sh | -2.81% | Softer: Q1 NI -2% YoY, FY25 NI -21%; fair value cut ₱10.04→9.42 — tempers the thesis | N/A — no partial-take rule set yet for this position | ₱7.57–7.67 (ATR-confirmed, from the original setup) — **🔴 broke below the ₱7.86-8.02 zone floor, gap to the stop now only ~0.5-1.8%, the tightest position on the account** | Both fills landed cleanly inside the stated ₱7.86-8.02 entry zone at the time, but price has since fallen through the zone floor — the weakest fundamental story of today's three fills (softer Q1/FY25 numbers, fair value already cut) is now showing up in the price action too. |
| **WEB** | ₱14.22 (400 sh, real fill, 2026-09-21) | ₱14.40, real intraday 2026-09-22 10:06 AM (+0.98%) | 82,600 sh | +1.27% | Q2 swung to profit, rev +96%; ₱2.02B + ₱4.23B capital injections (Gokongwei, JKS stake) | N/A — no partial-take rule set yet for this position | ₱13.50–13.70 (from the original setup) — gap ~3.9-5.3% | Filled near the lower part of the stated ₱14.20-14.45 entry zone, exactly as planned — a clean zone entry, same category as OGP/DMC. |
