...
**Last price update: 2026-09-10, 11:27 AM PH time — live intraday quotes
from filgit.com, cross-checked against investing.com's prior-day closes
(BLOOM and NIKL matched exactly; BPI/APX within a normal intraday move —
see Note on sourcing).** All entries staged (starter on touch +
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | **ICT** | Trend pullback (cleanest yet) | Uptrend continuation | Short-term + long-term candidate | Both | First PSE co. past ₱2T mkt cap; Mexico terminal expansion; "Strong Buy," 13 analysts, target ₱1,099 | ₱947–962 (pullback zone) | ₱900–915 (ATR-confirmed, corrected 2026-09-10 from ₱938–942) | T1 ₱1,000 · T2 (52w high) ₱1,049 | ₱987.00 (3:00 PM close, +1.23% today, range 970–993) | ⏳ Running further, hasn't pulled back into the zone yet | Hold in ₱947–962 zone confirmed by next candle not making a fresh low, OR reclaim of EMA10 (944.94) |
| 2 | **NIKL** | Trend pullback | Swing / Uptrend continuation | Short-term + long-term candidate | Both | 2025 earnings +312% YoY, tight nickel supply/demand tailwind, analyst target ₱5.53 | ₱4.25–4.45 | ₱3.90–3.95 | T1 ₱5.20–5.40 · T2 ₱5.65–5.73 | ₱4.78 (3:00 PM close, +0.63% today, range 4.72–4.80) | ❌ Above both zones — hasn't pulled back | Would need a pullback into ₱4.25–4.45 (or shallow ₱4.60–4.70) first, then a no-fresh-low candle |
| 3 | **OGP** | Trend pullback | Uptrend continuation | Short-term + long-term candidate | Both | Didipio mine life extended to 2037; $1.958B long-term investment confirmed; solid 2026 production guidance | ₱34.20–36.65 | ₱32.60–33.15 (ATR-confirmed, close to original ₱33.50 guess) | T1 ₱40.00 · T2 (52w high) ₱40.50 | ₱39.00 (3:00 PM close, +2.63% today, range 38.00–39.50) | ⏳ Running, closing in on T1/T2 | Next candle no fresh low, OR close above EMA10 (36.90), if price dips back into zone |
| 4 | **APX** | Trend pullback | Quick (was Uptrend — broke to new highs today) | Short-term + long-term candidate | Both | H1 2026 NI +68% YoY, Q1 EPS +92%; analyst target ₱22.00, above the new 52w high | ₱15.50–15.80 (deep) · ₱16.30–16.50 (shallow) | Trail (see detail below — old fixed stop ₱14.20–14.40 stale) | T1 ✅ hit · T2 ✅ hit · **T3 (new) ₱19.70–20.00**, trail don't hold | ₱18.20 (3:00 PM close, +4.00% today, range 17.80–19.18) | ✅ T1+T2 achieved, 52w high (19.18) holding from earlier today — trailing now, not targeting | N/A — already well past entry, managing the existing run |
| 5 | **Philweb (WEB)** | Trend pullback | Quick (momentum chase — never gave a pullback) | Short-term only | Short-term | Q2 swung to profit, rev +96%; ₱2.02B + ₱4.23B capital injections (Gokongwei, JKS stake) | ₱14.20–14.45 | ₱13.50–13.70 | ₱16.00–16.50 | ₱15.80 (3:00 PM close, +5.33% today, range 15.00–16.00) | ❌ Ran further — closed near T2's low end | N/A now (never touched zone) — would need a pullback into ₱14.20–14.45 first, then a no-fresh-low candle |
| 6 | **BPI** | Trend pullback | Swing | Short-term | Short-term | Q1 miss vs forecast but +1.7% YoY NI; 2026 outlook targets high-single-digit growth | ₱102.50–104.00 | ₱101.00–101.50 | T1 ₱108–109 · T2 ₱114–115 | ₱104.10 (3:00 PM close, +0.10% today, range 103.10–104.10) | ✅ **Starter FILLED** (20 sh @ ₱103.6050 avg) — closed right at the day's high, now just above the stated zone top | Next daily candle makes no fresh low vs. prior day, OR close back above EMA10 (104.63)/VWAP (104.33) |
| 7 | **BLOOM** | Speculative bottom-fish | Bottomfishing | Short-term, smallest size | Short-term | Q2 loss narrowed sharply (₱1.41B→₱345M YoY), EBITDA +35%, GGR +15% | ₱2.17–2.32 | ₱2.05–2.10 | T1 ₱2.45 · T2 ₱2.60 | ₱2.24 (3:00 PM close, -2.18% today, range 2.23–2.31) | ✅ **Starter FILLED** (1,000 sh @ ₱2.2567 avg) — still in zone | Next candle makes no fresh low, OR close back above ₱2.34 (EMA10) |
| 8 | **DMC** | Speculative bottom-fish | Bottomfishing | Short-term entry, long-term candidate on fundamentals | Short-term (long-term on fundamentals) | Softer: Q1 NI -2% YoY, FY25 NI -21%; fair value cut ₱10.04→9.42 — tempers the thesis | ₱7.86–8.02 | ₱7.57–7.67 (ATR-confirmed) | T1 ₱9.50–9.71 · T2 ₱10.65–11.00 | ₱8.22 (3:00 PM close, +3.14% today, range 7.95–8.24) | ✅ **Now above weekly MA20 (8.19)** — daily confirmation already satisfied; one more close like this and the weekly trigger fires too | Weekly close back above ₱8.19 (MA20) — daily EMA10 (7.87) already reclaimed, weekly now testing too |
