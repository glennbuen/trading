...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | **ICT** | Trend pullback (cleanest yet) | Uptrend continuation | Short-term + long-term candidate | Both | First PSE co. past ₱2T mkt cap; Mexico terminal expansion; "Strong Buy," 13 analysts, target ₱1,099 | ₱947–962 (pullback zone) | ₱900–915 (ATR-confirmed, corrected 2026-09-10 from ₱938–942) | T1 ₱1,000 · T2 (52w high) ₱1,049 | ₱934.00, real intraday 2026-09-17 01:23 PM (+1.30%) | 454,110 sh | 🟡 Holding the bounce, still below the entry zone (₱947–962). Stop (₱900-915) gap ~3.6-5.8%. | Hold in ₱947–962 zone confirmed by next candle not making a fresh low, OR reclaim of EMA10 (944.94) |
| 2 | **NIKL** | Trend pullback | Swing / Uptrend continuation | Short-term (T1 full-exit rule applies — see below) | Short-term | H1 2026 NI +93% YoY to ₱4.06B (Aug 7 report), EBITDA +67%; tight nickel supply/demand tailwind, analyst target ₱5.53 | ₱4.25–4.45 | ₱3.90–3.95 | T1 ₱5.20–5.40 (full exit here, not partial) | ₱4.26, real intraday 2026-09-17 01:23 PM (+1.67%) | 1,945,000 sh | ✅ **Starter FILLED** (1,000 sh @ ₱4.6738 avg) — real bounce today, stop gap widened back out to ~6.8-8.0% | Next candle not making a fresh low vs. today confirms full conviction; deeper zone ₱4.25–4.45 was the confirmation-add trigger, moot now that the starter already filled in the shallow zone |
| 3 | **OGP** | Trend pullback | Uptrend continuation | Short-term + long-term candidate | Both | Didipio mine life extended to 2037; $1.958B long-term investment confirmed; solid 2026 production guidance | ₱34.20–36.65 | ₱32.60–33.15 (ATR-confirmed, close to original ₱33.50 guess) | T1 ₱40.00 · T2 (52w high) ₱40.50 | ₱36.85, real intraday 2026-09-17 01:23 PM (0.00%, flat) | 186,900 sh | 🟡 Drifted back to essentially flat, right at the top edge of the entry zone (₱34.20-36.65) — gave back this morning's breakout, worth watching whether it holds here or falls back in | Next candle no fresh low, OR close above EMA10 (36.90) confirms the add |
| 4 | **APX** | Trend pullback | Quick (was Uptrend — broke to new highs, pullback already over) | Short-term + long-term candidate | Both | H1 2026 NI +68% YoY, Q1 EPS +92%; analyst target ₱22.00, above the new 52w high | ₱15.50–15.80 (deep) · ₱16.30–16.50 (shallow) | **Trail ~₱16.30–16.40** (fresh ATR-confirmed 2026-09-11, 1.5x ATR14=0.80 below the recent swing low, confluence with MA20 16.16 — no longer a rough estimate) | T1 ✅ hit · T2 ✅ hit · **T3 (new) ₱19.70–20.00**, trail don't hold | ₱18.28, real intraday 2026-09-17 01:23 PM (+0.66%) | 7,351,400 sh | ✅ Holding the run, trail (₱16.30–16.40) still has real room — ~10.8% below current | N/A — already well past entry, managing the existing run |
| 5 | **Philweb (WEB)** | Trend pullback | Quick (momentum chase — never gave a pullback) | Short-term only | Short-term | Q2 swung to profit, rev +96%; ₱2.02B + ₱4.23B capital injections (Gokongwei, JKS stake) | ₱14.20–14.45 | ₱13.50–13.70 | ₱16.00–16.50 | ₱14.58, real intraday 2026-09-17 01:23 PM (-2.28%) | 1,274,800 sh | 🟡 Falling further, now within ~0.9-2.1% of the ₱14.20–14.45 zone | Would need to keep falling into ₱14.20–14.45, then a no-fresh-low candle |
| 6 | **CNPF** | Trend pullback (weekly still unconfirmed) | Swing | Short-term (T1 full-exit rule applies) | Short-term | H1 2026 NI +6% YoY (₱4.14B), rev +15%; analyst "Strong Buy" (9), target ₱41.58 — but a month-old print, not fresh news behind Friday's move | ₱32.37–32.48 (EMA10/MA20 daily) | ₱31.00–31.20 (ATR-confirmed) | T1 ₱34.60–34.70 (weekly MA50/daily MA200 confluence, full exit) | ₱32.50, real intraday 2026-09-17 01:23 PM (0.00%, flat) | ✅ 557,500 sh — liquidity caveat RESOLVED, volume grew from 400 sh to 557,500 sh over the session | ✅ **Liquidity caveat from earlier is resolved** — real volume showed up (557,500 sh vs. 400 sh at 09:57 AM), back to flat vs. yesterday's close — this "zone touch" is a thin print, not real price discovery. Don't treat it as a confirmed test until real volume shows up; a single normal-size trade could move this well off ₱32.20 in either direction. | Next candle not making a fresh low vs. today confirms the starter — but only once it's backed by real volume, not a repeat of today's thin tape; weekly close above 33.62 (weekly MA200) would strengthen the read further |
...
|---|---|---|---|---|---|---|---|---|
| **LTG** | ₱11.333 (900 sh, real avg) | ₱15.10, real intraday 2026-09-17 01:23 PM (-0.66%, unchanged) | 1,186,800 sh | +33.24% | Q2 NI +24% YoY, rev +6.3%; dividend just paid (ex-date Sep 7), 8.2% yield | ✅ 30% sold at +20% | ₱14.29–14.52 (weekly ATR-based, 1–1.5x ATR14=0.46) — still above, gap to the top of the trail ~3.7% | Genuine multi-year weekly uptrend (recovered from ~₱8-9 in 2022-23), now testing its own 2021 high — a confirmed weekly close above that old high would be a real breakout signal. Daily RSI neutral (50.3), weekly RSI neutral (52.2) — room to continue, not extended. |
| **SCC** | ₱37.7423 (800 sh remaining, real avg — was 1,600) | ₱20.45, real intraday 2026-09-17 02:14 PM (**+22.46%, day range ₱16.70-21.10 — pulled back slightly from the day's ₱21.10 high but still holding ~90%+ of it**) | 16,891,300 sh (₱338.49M value) | -45.81% | Coal-block auction risk dominates — but see the fresh, contradictory news flagged below | ✅ **50% trimmed 2026-09-11** — sold 800 sh @ ₱17.90, realized loss ≈ -₱15,873.84 gross (see Trade Journal) | **30-min-before-close check (2:14 PM data, target was 2:30 PM): price is at ₱20.45 vs. the day's ₱21.10 high — a real but modest pullback (~3.1% off the peak), reads as holding the move into the close rather than fading it.** Decision (user, 2026-09-17): wait for the actual close, continue holding the remaining 800 sh if it's strong. Still no stop set on the remainder. | ⚠️ **Real disconnect, 2026-09-17: a genuinely bad fresh headline (Tribune, Sept 16) reports the DOE SCRAPPED the 2026 coal auction round to rewrite rules — Energy Sec. Garin explicitly said "you cannot award that to the same entity so you have to rebid," an explicit statement AGAINST Semirara automatically keeping its blocks.** Yet the stock is up +14.37% on real volume the very next session. Most likely explanation given the weekly RSI was deeply oversold (28.00, already flagged 2026-09-10 as raising bounce odds) — this reads as a technical mean-reversion bounce, not the market pricing in good fundamental news. Long-term weekly downtrend and the underlying contract-loss risk are UNCHANGED by this bounce. Full detail in the SCC section below. |
...
| **NIKL** | ₱4.6738 (real fill, 1,000 sh, 2026-09-11) | ₱4.26, real intraday 2026-09-17 01:23 PM (+1.67%) | 1,945,000 sh | -8.85% | H1 2026 NI +93% YoY to ₱4.06B, EBITDA +67%; tight nickel supply/demand tailwind | N/A — **T1-full-exit rule applies** (trader-not-investor, no partial take — see Exit methodology) | **Initial stop ₱3.90–3.95 active** (ATR-based, ~1.5x ATR14 below MA50) — real bounce today, gap widened back out to ~6.8-8.0% | **Fresh chart confirms 2026-09-11**: a pullback off a local top (~4.9-5.0), not a trend break — still above MA20/50/200, RSI cooled from overbought (70.39→59.20), which is healthy, not alarming. See full [NIKL entry](#nickel-asia-corp-nikl) below. Still just the Starter — price hasn't reached the ₱4.25–4.45 confirmation-add zone yet. |
