...
| 6 | **CNPF** | Trend pullback (weekly still unconfirmed) | Swing | Short-term (T1 full-exit rule applies) | Short-term | H1 2026 NI +6% YoY (₱4.14B), rev +15%; analyst "Strong Buy" (9), target ₱41.58 — but a month-old print, not fresh news behind Friday's move | ₱32.37–32.48 (EMA10/MA20 daily) | ₱31.00–31.20 (ATR-confirmed) | T1 ₱34.60–34.70 (weekly MA50/daily MA200 confluence, full exit) | ₱32.50, **confirmed close 2026-09-17 3:00 PM** (0.00%, flat) | ✅ 1,013,300 sh — liquidity caveat RESOLVED | ✅ Closed flat, real volume all session (1,013,300 sh vs. 400 sh at 09:57 AM) — right at the zone top, liquidity concern fully resolved | Next candle not making a fresh low vs. today confirms the starter — but only once it's backed by real volume, not a repeat of today's thin tape; weekly close above 33.62 (weekly MA200) would strengthen the read further |
...
| 11 | **AP** | **Corrected 2026-09-15 — Range-bound near the top of a 5-month consolidation, not a clean uptrend continuation** (see re-review below; matches COL Financial's own SIDEWAYS/LIGHTEN rating, previously an unresolved disagreement) | Range trade | Short-term entry only, long-term case weakened | Short-term | AboitizPower H1 2026 net income **+45% YoY to ₱18.4B** — real, but not enough on its own to override the technical caution below. | ₱44.55–45.35 (daily MA20/EMA10/VWAP cluster) | ₱42.30–42.80 (1–1.5x daily ATR14=0.91 below daily MA50/MA200 cluster ~43.7) | T1 ₱48.00 (the top of the range it's failed to break for 5 months, not a fresh breakout target — R:R ~1.2:1, weaker than it looks) | ₱45.05, **confirmed close 2026-09-17 3:00 PM** (-0.33%) | 230,400 sh | 🟡 Closed below the zone top (₱45.35), essentially range-bound as expected — same distribution caution still applies: net foreign selling (NFB/s -8.24M), weekly MACD line below its own signal, RSI parked at 51.94 daily/55.29 weekly (neutral, not trending) | A genuine breakout above ₱48 (the range top) on strong volume — the current MA-cluster touch is not, by itself, confirmation of anything in a range-bound name |
