...
| **SCC** | ₱37.7423 (400 sh remaining, real avg — was 1,600, then 800) | ₱20.25 (fill price, 2026-09-17) | 16,891,300 sh (session total as of last check) | -46.35% | Coal-block auction risk dominates — but see the fresh, contradictory news flagged below | ✅ **50% trimmed 2026-09-11** (sold 800 sh @ ₱17.90) **+ 50% of the remainder trimmed 2026-09-17** (sold 400 sh @ ₱20.25, into the day's real bounce) — realized loss ≈ -₱6,996.92 gross on this trim (see Trade Journal) | **Second trim executed 2026-09-17, ahead of the actual close** — user sold 400 of the remaining 800 sh at ₱20.25, using the real bounce rather than waiting for the close to fully resolve. **Decision on the last 400 sh, 2026-09-17 (user): revisit tomorrow (2026-09-18), based on whether the move continues.** Still no stop set on the remainder. | ⚠️ **Real disconnect, 2026-09-17: a genuinely bad fresh headline (Tribune, Sept 16) reports the DOE SCRAPPED the 2026 coal auction round to rewrite rules — Energy Sec. Garin explicitly said "you cannot award that to the same entity so you have to rebid," an explicit statement AGAINST Semirara automatically keeping its blocks.** Yet the stock is up +14.37% on real volume the very next session. Most likely explanation given the weekly RSI was deeply oversold (28.00, already flagged 2026-09-10 as raising bounce odds) — this reads as a technical mean-reversion bounce, not the market pricing in good fundamental news. Long-term weekly downtrend and the underlying contract-loss risk are UNCHANGED by this bounce. Full detail in the SCC section below. |
