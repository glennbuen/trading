...
| **OGP** | ₱36.525 (200 sh, real weighted avg: 100 sh @ ₱36.65 + 100 sh @ ₱36.40, 2026-09-18/21) | ₱35.70, real intraday 2026-09-22 1:14 PM (-2.33%) | 260,600 sh | -2.26% | Didipio mine life extended to 2037; $1.958B long-term investment confirmed; solid 2026 production guidance | N/A — no partial-take rule set yet for this position | ₱32.60–33.15 (ATR-confirmed, from the original setup) — real pullback today, gap now ~7.1-8.7% | Added 100 sh 2026-09-21 @ ₱36.40, still within the original ₱34.20-36.65 entry zone — a straightforward average-down within the same zone, not a fresh confirmation signal. |
| **DMC** | ₱7.9329 (700 sh, real weighted avg: 100 sh @ ₱7.95 + 600 sh @ ₱7.93, 2026-09-18) | ₱7.70, real intraday 2026-09-22 1:14 PM (-2.04%) | 1,628,800 sh | -2.94% | Softer: Q1 NI -2% YoY, FY25 NI -21%; fair value cut ₱10.04→9.42 — tempers the thesis | N/A — no partial-take rule set yet for this position | ₱7.57–7.67 (ATR-confirmed, from the original setup) — **🔴 today's intraday low was ₱7.63 — INSIDE the ₱7.57-7.67 stop zone. The stop has already been tested today, not just approached.** Current price (₱7.70) is a bounce back above it, but this needs a direct decision, not another routine check. | Both fills landed cleanly inside the stated ₱7.86-8.02 entry zone at the time, but price has since fallen through the zone floor and tested the stop itself intraday — the weakest fundamental story of today's three fills (softer Q1/FY25 numbers, fair value already cut) is now showing up clearly in the price action. |
| **WEB** | ₱14.22 (400 sh, real fill, 2026-09-21) | ₱14.24, real intraday 2026-09-22 1:14 PM (-0.14%) | 331,400 sh | +0.14% | Q2 swung to profit, rev +96%; ₱2.02B + ₱4.23B capital injections (Gokongwei, JKS stake) | N/A — no partial-take rule set yet for this position | ₱13.50–13.70 (from the original setup) — gap ~3.9-5.3% | Filled near the lower part of the stated ₱14.20-14.45 entry zone, exactly as planned — a clean zone entry, same category as OGP/DMC. |
