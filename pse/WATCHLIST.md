...
| 7 | **BPI** | Trend pullback | Swing | Short-term | Short-term | Q1 miss vs forecast but +1.7% YoY NI; 2026 outlook targets high-single-digit growth | ₱102.50–104.00 | ₱101.00–101.50 | T1 ₱108–109 · T2 ₱114–115 | ₱101.00 (day of the stop-out) | ✅ **CLOSED 2026-09-16 — stopped out at ₱100.90, plan executed as designed.** No longer an open position; would need a fresh setup (new zone, new stop) to be reconsidered, not just a return to the old entry range. | Moot — position closed |
...
| ~~**BPI**~~ | ~~₱103.6050~~ | **✅ CLOSED 2026-09-16 — stopped out** | **-2.61%** | Q1 miss vs forecast but +1.7% YoY NI | N/A — closed at a loss, not a partial take | — | Sold 20 sh @ ₱100.90, market order, same day the stop broke. Realized loss ≈ -₱54.10 gross. Full detail in `TRADE_JOURNAL.md`. No longer a position to monitor. |
