...
| 2 | **NIKL** | Trend pullback | Swing / Uptrend continuation | Short-term (T1 full-exit rule applies — see below) | Short-term | H1 2026 NI +93% YoY to ₱4.06B (Aug 7 report), EBITDA +67%; tight nickel supply/demand tailwind, analyst target ₱5.53 | ₱4.25–4.45 | ₱3.90–3.95 | T1 ₱5.20–5.40 (full exit here, not partial) | ₱3.98, real intraday 2026-09-25 1:08 PM (+0.25%) | 719,000 sh | ✅ **Starter FILLED** (1,000 sh @ ₱4.6738 avg) — gap ~4.8-6.0% | Next candle not making a fresh low vs. today confirms full conviction; deeper zone ₱4.25–4.45 was the confirmation-add trigger, moot now that the starter already filled in the shallow zone |
| 3 | **OGP** | Trend pullback | Uptrend continuation | Short-term + long-term candidate | Both | Didipio mine life extended to 2037; $1.958B long-term investment confirmed; solid 2026 production guidance | ₱34.20–36.65 | ₱32.60–33.15 (ATR-confirmed, close to original ₱33.50 guess) | T1 ₱40.00 · T2 (52w high) ₱40.50 | ₱35.55, real intraday 2026-09-25 1:08 PM (-0.42%) | 260,300 sh | ✅ **Filled 2026-09-18, 100 sh @ ₱36.65; added 100 sh 2026-09-21 @ ₱36.40**, see Current Holdings above — 200 sh total, weighted avg ₱36.525, both fills inside the entry zone | Moot now — position filled |
| 4 | **APX** | Trend pullback | Quick (was Uptrend — broke to new highs, pullback already over) | Short-term + long-term candidate | Both | H1 2026 NI +68% YoY, Q1 EPS +92%; analyst target ₱22.00, above the new 52w high | ₱15.50–15.80 (deep) · ₱16.30–16.50 (shallow) | **Trail ~₱16.30–16.40** (fresh ATR-confirmed 2026-09-11, 1.5x ATR14=0.80 below the recent swing low, confluence with MA20 16.16 — no longer a rough estimate) | T1 ✅ hit · T2 ✅ hit · **T3 (new) ₱19.70–20.00**, trail don't hold | ₱17.54, real intraday 2026-09-25 1:08 PM (-0.57%) | 894,800 sh | ✅ Pulled back, trail (₱16.30–16.40) still has real room — ~11.0% below current | N/A — already well past entry, managing the existing run |
| 5 | **Philweb (WEB)** | Trend pullback | Quick (momentum chase — never gave a pullback) | Short-term only | Short-term | Q2 swung to profit, rev +96%; ₱2.02B + ₱4.23B capital injections (Gokongwei, JKS stake) | ₱14.20–14.45 | ₱13.50–13.70 | ₱16.00–16.50 | ₱14.04, real intraday 2026-09-25 1:08 PM (+0.14%) | 2,880,100 sh | ✅ **Filled 2026-09-21, 400 sh @ ₱14.22**, see Current Holdings above — essentially flat, holding above the zone floor | Moot now — position filled |
| 6 | **CNPF** | Trend pullback (weekly still unconfirmed) | Swing | Short-term (T1 full-exit rule applies) | Short-term | H1 2026 NI +6% YoY (₱4.14B), rev +15%; analyst "Strong Buy" (9), target ₱41.58 — but a month-old print, not fresh news behind Friday's move | ₱32.37–32.48 (EMA10/MA20 daily) | ₱31.00–31.20 (ATR-confirmed) | T1 ₱34.60–34.70 (weekly MA50/daily MA200 confluence, full exit) | ₱32.95, real intraday 2026-09-25 1:08 PM (-0.45%) | 298,300 sh | 🟡 Pulled back to just above the ₱32.37-32.48 zone, volume built up through the session — no longer thin | Next candle not making a fresh low vs. today confirms the starter — but only once it's backed by real volume, not a repeat of today's thin tape; weekly close above 33.62 (weekly MA200) would strengthen the read further |
...
| **OGP** | ₱36.525 (200 sh, real weighted avg: 100 sh @ ₱36.65 + 100 sh @ ₱36.40, 2026-09-18/21) | ₱35.55, real intraday 2026-09-25 1:08 PM (-0.42%) | 260,300 sh | -2.67% | Didipio mine life extended to 2037; $1.958B long-term investment confirmed; solid 2026 production guidance | N/A — no partial-take rule set yet for this position | ₱32.60–33.15 (ATR-confirmed, from the original setup) — real pullback continuing, gap now ~6.6-8.2% | Added 100 sh 2026-09-21 @ ₱36.40, still within the original ₱34.20-36.65 entry zone — a straightforward average-down within the same zone, not a fresh confirmation signal. |
...
| **WEB** | ₱14.22 (400 sh, real fill, 2026-09-21) | ₱14.04, real intraday 2026-09-25 1:08 PM (+0.14%) | 2,880,100 sh | -1.27% | Q2 swung to profit, rev +96%; ₱2.02B + ₱4.23B capital injections (Gokongwei, JKS stake) | N/A — no partial-take rule set yet for this position | ₱13.50–13.70 (from the original setup) — gap ~3.9-5.3% | Filled near the lower part of the stated ₱14.20-14.45 entry zone, exactly as planned — a clean zone entry, same category as OGP/DMC. |
