...
| **SCC** | ₱37.7423 (800 sh remaining, real avg — was 1,600) | ₱20.55, real intraday 2026-09-17 01:23 PM (**+23.05%, accelerating — day range ₱16.70-20.90**) | 12,336,100 sh (₱253.5M+ value — a genuinely major volume day, not a fluke print) | -45.55% | Coal-block auction risk dominates — but see the fresh, contradictory news flagged below | ✅ **50% trimmed 2026-09-11** — sold 800 sh @ ₱17.90, realized loss ≈ -₱15,873.84 gross (see Trade Journal) | **Decision made 2026-09-17 (user): wait for today's close — if strong, continue holding the remaining 800 sh.** No stop set yet; already half-out from the 09-11 trim. Move has nearly doubled in strength since the 10:48 AM check (+14.37%→+23.05%) — "strong close" still not numerically defined, worth pinning down before 2:30 PM. | ⚠️ **Real disconnect, 2026-09-17: a genuinely bad fresh headline (Tribune, Sept 16) reports the DOE SCRAPPED the 2026 coal auction round to rewrite rules — Energy Sec. Garin explicitly said "you cannot award that to the same entity so you have to rebid," an explicit statement AGAINST Semirara automatically keeping its blocks.** Yet the stock is up +14.37% on real volume the very next session. Most likely explanation given the weekly RSI was deeply oversold (28.00, already flagged 2026-09-10 as raising bounce odds) — this reads as a technical mean-reversion bounce, not the market pricing in good fundamental news. Long-term weekly downtrend and the underlying contract-loss risk are UNCHANGED by this bounce. Full detail in the SCC section below. |
