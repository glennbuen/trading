...
| 3 | **OGP** | Trend pullback | Uptrend continuation | Short-term + long-term candidate | Both | Didipio mine life extended to 2037; $1.958B long-term investment confirmed; solid 2026 production guidance | ₱34.20–36.65 | ₱32.60–33.15 (ATR-confirmed, close to original ₱33.50 guess) | T1 ₱40.00 · T2 (52w high) ₱40.50 | ₱37.00, real intraday 2026-09-18 11:15 AM (+0.41%) | 169,700 sh | 🟢 Back above the top edge of the entry zone (₱34.20-36.65), real strength today | Next candle no fresh low, OR close above EMA10 (36.90) confirms the add |
...
| **ICT** | ₱915.00 (10 sh, real fill, 2026-09-18) | ₱913.00, real intraday 2026-09-18 11:15 AM (-2.35%) | 293,900 sh | -0.22% | First PSE co. past ₱2T mkt cap; Mexico terminal expansion; "Strong Buy," 13 analysts, target ₱1,099 | N/A — no partial-take rule set yet for this position | **⚠️ Kept at ₱900–915 (user's explicit choice, 2026-09-18)** — this is the SAME range the original setup called a stop-loss zone, not an entry zone (the stated entry was ₱947–962). Filling at ₱915 means the cushion to the stop is only ~0-1.6%, far thinner than every other position on this account. Flagged plainly: this is a real, near-zero-margin entry, not a standard staged pullback fill. | Bought right at what this account's own prior analysis called the stop level, not inside the ₱947-962 pullback zone. Real catalyst on file (US government 10% stake, Nvidia $5B investment, Apple chip partnership), but the entry timing here doesn't match this account's usual staged-pullback pattern. |
